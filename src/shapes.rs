...
//     Shape {
//         vertices: vec![
//             Vertex { pos: [0.0, 0.0, 0.0],  col: [0.5, 0.5, 0.5],   uv_map: [0.5, 0.5], uv_scale, normal: [0.5, 0.5, 0.0] },

//             Vertex { pos: [0.0000000, 0.5, 0.0],    col: [1.00, 0.00, 0.00], uv_map: [0.5, 0.00],       uv_scale, normal: [0.5, 0.0, 0.0] },
//             Vertex { pos: [0.4330127, 0.25, 0.0],   col: [0.75, 0.75, 0.00], uv_map: [0.9330127, 0.25], uv_scale, normal: [0.9330127, 0.25, 0.0] },
//             Vertex { pos: [0.4330127, -0.25, 0.0],  col: [0.00, 1.00, 0.00], uv_map: [0.9330127, 0.75], uv_scale, normal: [0.9330127, 0.75, 0.0] },
//             Vertex { pos: [0.0000000, -0.5, 0.0],   col: [0.00, 0.75, 0.75], uv_map: [0.5, 1.00],       uv_scale, normal: [0.5, 1.00, 0.0] },
//             Vertex { pos: [-0.4330127, -0.25, 0.0], col: [0.00, 0.00, 1.00], uv_map: [0.0669873, 0.75], uv_scale, normal: [0.0669873, 0.75, 0.0] },
//             Vertex { pos: [-0.4330127, 0.25, 0.0],  col: [0.75, 0.00, 0.75], uv_map: [0.0669873, 0.25], uv_scale, normal: [0.0669873, 0.25, 0.0] },
//         ],
//         indices: vec![
//             0, 2, 1,
//             0, 3, 2,
